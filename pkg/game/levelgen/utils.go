...
// isRoomStillConnected delegates to setup.RoomStillConnectedIfBlock (R8 / I7).
func isRoomStillConnected(g *state.Game, roomName string, entryCellsForRoom []*world.Cell, additionalBlockedCell *world.Cell) bool {
	return setup.RoomStillConnectedIfBlock(g, roomName, entryCellsForRoom, additionalBlockedCell)
}
